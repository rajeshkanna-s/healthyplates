...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send("service_f07gds7", "template_2x0nf7w", {
        name: formData.name,
          ...
          <div className="lg:col-span-1">
            <div className="space-y-6">
              ...
              {contactInfo.map((info, index) => (
                <div
                  key={index}
                  className="card-health p-6 group hover:scale-105 transition-all duration-200"
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-health font-medium mb-1">
                        {info.details}
                      </p>
