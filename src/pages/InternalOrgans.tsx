...
export default function InternalOrgans() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-purple-600 to-violet-500 bg-clip-text text-transparent">
            Internal Organs Explorer
          </h1>
          <p className="text-xl text-muted-foreground">Click on any organ to explore detailed information</p>
        </div>
            ...
            {selectedOrgan ? (
              <Card className="animate-fade-in">
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {selectedOrgan.functions.map((func, index) => (
                        <div key={index} className="flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: selectedOrgan.color }} />
                          <span className="text-sm text-muted-foreground">{func}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {/* Fun Facts */}
                  <div>
                    <h3 className="font-semibold mb-2">Fascinating Facts</h3>
                    <div className="space-y-2">
                      {selectedOrgan.facts.map((fact, index) => (
                  ...
                  {/* Common Disorders */}
                  <div>
                    <h3 className="font-semibold mb-2">Related Health Conditions</h3>
                    <div className="flex flex-wrap gap-2">
                      {selectedOrgan.disorders.map((disorder, index) => (
                        <Badge key={index} variant="secondary">{disorder}</Badge>
                      ))}
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="h-full flex items-center justify-center bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/20 dark:to-violet-950/20">
                <CardContent className="text-center p-12">
                  <div className="w-24 h-24 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center mx-auto mb-6">
                    <ZoomIn className="w-12 h-12 text-purple-500" />
                  </div>
                  <h3 className="text-xl font-semibold mb-2">Select an Organ</h3>
                  <p className="text-muted-foreground">
                    Click on any organ in the body viewer or use the quick navigation buttons above to explore detailed information about each organ.
                  </p>
                </CardContent>
              </Card>
            )}
