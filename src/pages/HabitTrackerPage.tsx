            ...
            <Card>
              <CardContent className="pt-4 sm:pt-6 px-2 sm:px-6">
                <ScrollArea className="w-full" type="always">
                  <div className="min-w-[480px] pb-4">
                    {/* Header row with dates */}
                    <div className="grid grid-cols-[80px_repeat(7,36px)_50px] sm:grid-cols-[minmax(120px,160px)_repeat(7,minmax(44px,1fr))_minmax(60px,80px)] gap-1 sm:gap-2 mb-4 pb-2 border-b">
                    ...
                    {activeHabits.map(habit => {
                      ...
                      return (
                        <div key={habit.id} className="grid grid-cols-[80px_repeat(7,36px)_50px] sm:grid-cols-[minmax(120px,160px)_repeat(7,minmax(44px,1fr))_minmax(60px,80px)] gap-1 sm:gap-2 items-center py-2 border-b last:border-0">
